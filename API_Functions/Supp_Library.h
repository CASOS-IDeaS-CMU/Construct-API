...
namespace dynet {
	...
	extern "C" CONSTRUCT_API Model * create_custom_model(const std::string & model_name, const ParameterMap & parameters, Construct * construct);
	...
	extern "C" CONSTRUCT_API media_user* create_custom_media_user(Social_Media* _media, Nodeset::iterator node);
}
