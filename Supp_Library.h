...
namespace dynet {
	...
	CONSTRUCT_API Model* create_custom_model(const std::string & model_name, ParameterMap parameters, Construct * construct);
	...
	CONSTRUCT_API Output* create_custom_output(const std::string& output_name, ParameterMap parameters, Construct* construct);
